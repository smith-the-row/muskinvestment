        ...
        <div className="container d-flex flex-column">
          <div className="row">
            <div className="col-sm-12 col-md-6 col-lg-6 d-flex flex-column">
              <h3>About Us</h3>
              <p>
                musk investment is one of the leading cryptocurrency mining
            ...
            <div className="col-sm-12 col-md-4 col-lg-4 d-flex flex-column mb-5">
              <h3>Contact Info</h3>
              <p>muskinvestment@gmail.com</p>
              <p>
                musk investment Head office US: 2944 N 44th Street,Phoenix,AZ
                85018
              </p>
              <p>
          ...
          <div className="text-center mt-3">
            <p>
              COPYRIGHT © RESVERED musk investment 2014 -{" "}
